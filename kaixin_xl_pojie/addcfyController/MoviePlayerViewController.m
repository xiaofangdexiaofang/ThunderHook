...
#import "SPVideoPlayer/SPVideoPlayer.h"
#import "SPVideoPlayer/SPVideoItem.h"
...
- (UIView *)playerFatherView {
    ...
    if (!_playerFatherView) {
        _playerFatherView = [[UIView alloc] initWithFrame:CGRectMake(0, FatherViewY, ScreenWidth,  ScreenWidth*ScreenWidth/ScreenHeight)];
    }
...
- (SPVideoItem *)videoItem {
    if (!_videoItem) {
        ...
        _videoItem.videoURL         = [NSURL URLWithString:@""];
...
//        videoItem.title            = @"测试";
//        videoItem.videoURL         = [NSURL URLWithString:@""];
