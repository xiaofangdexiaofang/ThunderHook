...
@class MyNavigationController; @class AppDelegate; @class ORDownloadDetailViewController; @class TDSlideViewController; @class PersonalCenterVC_new; @class TDDownloadListViewCell; @class CFYCustomPlayerController; @class TDSlideDownloadListVC; @class XL_TabBarController; @class DLDownloadTask; @class UINavigationController; @class HomePageVC; @class CFYHomePageViewController; @class TDDownloadListADCell; @class TDSlideHomeViewController; @class XTFileListController; @class LinkInputController; @class TDDiscoveryViewController; 
...
static void _logos_method$_ungrouped$TDSlideDownloadListVC$getClickYBBtnNotification$(_LOGOS_SELF_TYPE_NORMAL TDSlideDownloadListVC* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, NSNotification * notification){
    ...
    CFYCustomPlayerController *playerVC = [[_logos_static_class_lookup$CFYCustomPlayerController() alloc] init];
