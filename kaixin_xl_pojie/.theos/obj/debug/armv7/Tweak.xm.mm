...
@class HomePageVC; @class TDDiscoveryViewController; @class TDSlideViewController; @class TDDownloadListViewCell; @class MyNavigationController; @class XTFileListController; @class TDDownloadListADCell; @class CFYHomePageViewController; @class XL_TabBarController; @class TDSlideHomeViewController; @class AppDelegate; @class UINavigationController; @class CFYCustomPlayerController; @class PersonalCenterVC_new; @class ORDownloadDetailViewController; @class LinkInputController; @class TDSlideDownloadListVC; @class DLDownloadTask; 
